package com.gayeway.Razorpay.vault.dto.Request;

import com.gayeway.Razorpay.vault.validation.ExpiryYear;
...
public record TokenizeRequest(
        ...
        @Min(value = 2026, message = "Expiry must be between 1 to 12")
        @ExpiryYear
        Integer expiryYear,
        UUID customerId,
